...
class Block(nn.Module):
    ...
    def forward(self, x, cross_view, fast, idx, B, T, W):
...
class VisionTransformer_slow(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.cross_view = CrossAttention(embed_dim, num_heads=num_heads, qk_scale=qk_scale, attn_drop=attn_drop_rate, proj_drop=drop_rate)
    ...
    def forward_features(self, x,lis):
        ...
        for idx,blk in enumerate(self.blocks):
            x = blk(x, self.cross_view, lis[idx], idx, B, T, W)
