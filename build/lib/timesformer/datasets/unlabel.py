...
class Unlabel(torch.utils.data.Dataset):
    """
    ...
    def __getitem__(self, index):
        ...
        mask_ratio = np.random.beta(0.2,0.2)
        tube_strong = TubeMaskingGenerator(input_size=window_size, mask_ratio=mask_ratio)
        ...
        for i_try in range(self._num_retries):
            ...
            try:
                ...
                video_container_aug = container.get_video_container(
                    self._path_to_videos[index],
                    self.cfg.DATA_LOADER.ENABLE_MULTI_THREAD_DECODE,
                    self.cfg.DATA.DECODING_BACKEND,
                )
            ...
            if video_container is None or video_container_aug is None:
                logger.warning(
            ...
            if frames is None or frames_aug is None:
                logger.warning(
            ...
            return frames_weak, frames_strong, label, tube_strong(), {}
